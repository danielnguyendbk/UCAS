  ...
  return (
    <div className="p-5 md:p-6 space-y-5">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-0.5">Báo cáo sự cố cơ sở vật chất phòng học</p>
      </div>
      ...
      {submitted && (
        <div className="flex items-start gap-3 p-4 bg-green-50 border border-green-200 rounded-xl text-sm text-green-800 animate-in fade-in slide-in-from-top-2">
          ...
          <div>
            ...
            <p className="text-xs text-green-700 mt-0.5">Mã yêu cầu: YC-LEC-802. Đội kỹ thuật sẽ tiếp nhận và xử lý sớm.</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <Select value={form.type} onValueChange={(v) => setForm((f) => ({ ...f, type: v }))}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="equipment">Thiết bị giảng dạy</SelectItem>
                  ...
                  <div className="space-y-1.5 md:col-span-2">
                    ...
                    <Input
                      placeholder="VD: A-201, Giảng đường tòa C..."
                      value={form.location}
                  ...
                  <div className="flex items-center justify-center w-full">
                    <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-200 rounded-xl cursor-pointer hover:bg-gray-50 transition-colors">
                      <div className="flex flex-col items-center justify-center pt-5 pb-6">
                        ...
                        <p className="text-xs text-gray-500">Nhấp hoặc kéo thả tập tin</p>
                        <p className="text-[10px] text-gray-400 mt-1">PNG, JPG, MP4 (Tối đa 10MB)</p>
                      </div>
                ...
                <div className="flex gap-3 pt-2">
                  <Button type="submit" className="bg-orange-600 hover:bg-orange-700 text-sm gap-2" disabled={submitting}>
