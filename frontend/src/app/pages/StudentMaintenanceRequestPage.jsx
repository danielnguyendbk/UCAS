...
const StudentMaintenanceRequestPage = () => {
  ...
  return (
    <div className="p-5 md:p-6 space-y-5">
      <div>
        <h1 className="text-xl font-bold text-gray-900">Báo cáo sự cố (Sinh viên)</h1>
        <p className="text-sm text-gray-500 mt-0.5">Giúp nhà trường cải thiện CSVC bằng cách báo cáo hư hỏng thiết bị</p>
      </div>
      ...
      {submitted && (
        <div className="flex items-start gap-3 p-4 bg-green-50 border border-green-200 rounded-xl text-sm text-green-800 animate-in fade-in slide-in-from-top-2">
          ...
          <div>
            ...
            <p className="text-xs text-green-700 mt-0.5">Mã yêu cầu: YC-STU-123. Đội kỹ thuật sẽ tiếp nhận và xử lý sớm nhất có thể.</p>
            <Button variant="outline" size="sm" className="mt-2 text-xs border-green-200 hover:bg-green-100" onClick={() => setSubmitted(false)}>Gửi thêm yêu cầu khác</Button>
          </div>
        </div>
      )}
          ...
          <Card className="shadow-sm border-0 ring-1 ring-gray-200">
            <CardHeader className="pb-4">
              <CardTitle className="text-sm font-semibold text-gray-700 flex items-center gap-2">
                ...
                Thông tin sự cố cơ sở vật chất
              </CardTitle>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <Select value={form.type} onValueChange={(v) => setForm((f) => ({ ...f, type: v }))}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="plumbing">Nước (Nhà vệ sinh, Vòi nước)</SelectItem>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Select value={form.urgency} onValueChange={(v) => setForm((f) => ({ ...f, urgency: v }))}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="urgent">Cần xử lý ngay</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  <div className="space-y-1.5 md:col-span-2">
                    ...
                    <Input
                      placeholder="VD: A-201, Giảng đường tòa B..."
                      value={form.location}
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    placeholder="Mô tả cụ thể hư hỏng để kỹ thuật viên chuẩn bị dụng cụ..."
                ...
                <div className="space-y-2">
                  <Label className="text-xs font-semibold text-gray-700">Ảnh minh chứng</Label>
                  <div className="flex items-center justify-center w-full">
                    <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-200 rounded-xl cursor-pointer hover:bg-gray-50 transition-colors">
                      <div className="flex flex-col items-center justify-center pt-5 pb-6">
                        ...
                        <p className="text-xs text-gray-500">Nhấp để tải ảnh lên</p>
                      </div>
                  ...
                  {attachments.length > 0 && (
                    <div className="flex flex-wrap gap-2 mt-2">
                      {attachments.map(a => (
                        <div key={a.id} className="flex items-center gap-2 px-2 py-1 bg-blue-50 text-blue-700 rounded text-[10px] border border-blue-100">
                ...
                <div className="flex gap-3 pt-2">
                  <Button type="submit" className="bg-blue-600 hover:bg-blue-700 text-sm gap-2 h-10 px-6" disabled={submitting}>
                    {submitting ? "Đang gửi..." : <><Send className="w-4 h-4" /> Gửi báo cáo</>}
                  </Button>
                  <Button type="button" variant="outline" className="text-sm h-10 px-6" onClick={() => setForm({ type: "", location: "", description: "", urgency: "normal" })}>
                    Làm mới
                  </Button>
                </div>
              </form>
