  ...
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [
        ...
        children: [
          /* @__PURE__ */ jsxs("div", {
            children: [
              /* @__PURE__ */ jsx("h1", {
                ...
                children: "Ph\xE2n ph\xF2ng & Ki\u1EC3m tra xung \u0111\u1ED9t",
              }),
              /* @__PURE__ */ jsx("p", {
                className: "text-sm text-gray-500 mt-0.5",
                children: "H\u1ECDc k\u1EF3 1, N\u0103m h\u1ECDc 2024-2025",
              }),
            ],
          }),
          /* @__PURE__ */ jsxs(Button, {
            ...
            children: [
              ...
              isRunning
                ? "\u0110ang ph\xE2n c\xF4ng..."
                : "Ph\xE2n c\xF4ng t\u1EF1 \u0111\u1ED9ng",
            ],
          }),
        ],
      }),
      runDone &&
        /* @__PURE__ */ jsxs("div", {
          className:
            "flex items-start gap-3 p-4 bg-green-50 border border-green-200 rounded-xl text-sm text-green-800",
          children: [
            ...
            /* @__PURE__ */ jsxs("div", {
              children: [
                /* @__PURE__ */ jsx("p", {
                  ...
                  children:
                    "Ph\xE2n c\xF4ng t\u1EF1 \u0111\u1ED9ng ho\xE0n t\u1EA5t!",
                }),
                /* @__PURE__ */ jsx("p", {
                  className: "text-xs text-green-700 mt-0.5",
                  children:
                    "\u0110\xE3 ph\xE2n 22 l\u1EDBp h\u1ECDc ph\u1EA7n th\xE0nh c\xF4ng. 3 l\u1EDBp kh\xF4ng th\u1EC3 ph\xE2n t\u1EF1 \u0111\u1ED9ng do r\xE0ng bu\u1ED9c \u0111\u1EB7c bi\u1EC7t \u2014 c\u1EA7n x\u1EED l\xFD th\u1EE7 c\xF4ng.",
                }),
              ],
            }),
          ],
      ...
      /* @__PURE__ */ jsx("div", {
        ...
        children: [
          {
            key: "allocation",
            label: "Danh s\xE1ch ph\xE2n ph\xF2ng",
            icon: Building2,
          },
          {
            key: "conflicts",
            label: `Xung \u0111\u1ED9t l\u1ECBch (${conflicts.length})`,
            icon: AlertTriangle,
          },
        ].map((tab) => {
          const Icon = tab.icon;
            ...
            children: /* @__PURE__ */ jsxs(Table, {
              children: [
                  ...
                  children: /* @__PURE__ */ jsxs(TableRow, {
                    ...
                    children: [
                      /* @__PURE__ */ jsx(TableHead, {
                        ...
                        children: "M\xE3 l\u1EDBp HP",
                      }),
                      /* @__PURE__ */ jsx(TableHead, {
                        className: "text-xs font-semibold text-gray-600",
                        children: "T\xEAn m\xF4n",
                      }),
                      /* @__PURE__ */ jsx(TableHead, {
                        className:
                ...
                /* @__PURE__ */ jsx(TableBody, {
                  children: allocationList.map((row) =>
                    /* @__PURE__ */ jsxs(
                      TableRow,
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsx(TableCell, {
                            className:
                              "font-mono text-xs font-bold text-blue-700",
                            children: row.id,
                          }),
                          /* @__PURE__ */ jsx(TableCell, {
                          ...
                          /* @__PURE__ */ jsx(TableCell, {
                            ...
                            children: row.reqRoom,
                          }),
                          /* @__PURE__ */ jsxs(TableCell, {
                            className:
                              "text-xs text-gray-600 whitespace-nowrap",
                            children: [row.day, " \xB7 ", row.slot],
                          }),
                          /* @__PURE__ */ jsx(TableCell, {
                          ...
                          /* @__PURE__ */ jsxs(TableCell, {
                            ...
                            children: [
                              row.status === "ok" &&
                                /* @__PURE__ */ jsxs(Badge, {
                                  className:
                                    "bg-green-100 text-green-700 hover:bg-green-100 text-[11px]",
                                  children: [
                                    /* @__PURE__ */ jsx(CheckCircle, {
                              ...
                              row.status === "unassigned" &&
                                /* @__PURE__ */ jsx(Badge, {
                                  className:
                                    "bg-orange-100 text-orange-700 hover:bg-orange-100 text-[11px]",
                                  children: "Ch\u01B0a ph\xE2n",
                                }),
                              row.status === "conflict" &&
                                /* @__PURE__ */ jsxs(Badge, {
                                  className:
                                    "bg-red-100 text-red-700 hover:bg-red-100 text-[11px]",
                                  children: [
                          ...
                          /* @__PURE__ */ jsx(TableCell, {
                            ...
                            children: /* @__PURE__ */ jsx("button", {
                              className:
                                "text-xs text-blue-600 hover:text-blue-800 font-medium px-2 py-1 rounded hover:bg-blue-50",
        ...
        /* @__PURE__ */ jsx("div", {
          ...
          children:
            conflicts.length === 0
              ? /* @__PURE__ */ jsxs("div", {
                  className:
                    "flex flex-col items-center justify-center py-16 bg-white rounded-xl border border-gray-200 text-center",
                  children: [
                    /* @__PURE__ */ jsx(CheckCircle, {
                    ...
                    /* @__PURE__ */ jsx("p", {
                      ...
                      children: "Kh\xF4ng ph\xE1t hi\u1EC7n xung \u0111\u1ED9t",
                    }),
                    /* @__PURE__ */ jsx("p", {
                      className: "text-sm text-gray-400 mt-1",
                      children:
                        "To\xE0n b\u1ED9 l\u1ECBch ph\xE2n ph\xF2ng h\u1EE3p l\u1EC7",
                    }),
                  ],
                })
              : conflicts.map((c) => {
                              ...
                              children: [
                                /* @__PURE__ */ jsxs("div", {
                                  ...
                                  children: [
                                    ...
                                    /* @__PURE__ */ jsxs("span", {
                                      className: "text-xs text-gray-500",
                                      children: [c.day, " \xB7 ", c.slot],
                                    }),
                                    c.room !== "\u2014" &&
                                      /* @__PURE__ */ jsxs("span", {
                                        className:
                                          "text-xs font-medium bg-gray-100 text-gray-600 px-2 py-0.5 rounded",
                                        children: ["Ph\xF2ng ", c.room],
                                      }),
                                  ],
                                }),
                                /* @__PURE__ */ jsx("p", {
                                ...
                                /* @__PURE__ */ jsxs("div", {
                                  ...
                                  children: [
                                    /* @__PURE__ */ jsxs("div", {
                                      className:
                                        "bg-gray-50 rounded-lg px-3 py-2 text-xs text-gray-600",
                                      children: [
                                        /* @__PURE__ */ jsx("span", {
                                          className:
