...
@RestController
@RequestMapping("/api/student/class-sessions")
public class StudentClassSessionController {

    private final ClassSessionService classSessionService;

    public StudentClassSessionController(ClassSessionService classSessionService) {
        this.classSessionService = classSessionService;
    }

    @GetMapping
    public ResponseEntity<ApiResponse<?>> getStudentClassSessions(
        ...
        List<ClassSessionResponse> list = classSessionService.getStudentClassSessions(
