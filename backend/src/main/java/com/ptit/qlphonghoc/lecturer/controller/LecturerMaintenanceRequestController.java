...
@RestController
@RequestMapping("/api/lecturer/maintenance-requests")
public class LecturerMaintenanceRequestController {

    private final MaintenanceRequestService service;

    public LecturerMaintenanceRequestController(MaintenanceRequestService service) {
    ...
    public ResponseEntity<MaintenanceRequestResponse> create(
        ...
        return ResponseEntity
                .created(URI.create("/api/lecturer/maintenance-requests/" + response.id()))
                .body(response);
    }
}
