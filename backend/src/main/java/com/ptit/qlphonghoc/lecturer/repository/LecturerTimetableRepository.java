...
public interface LecturerTimetableRepository extends JpaRepository<Lecturer, Integer> {
    ...
    @Query(value = """
        ...
        ORDER BY
            ...
            cs.section_code
        """, nativeQuery = true)
    List<LecturerTimetableProjection> findTimetableByLecturerId(
    ...
    interface LecturerTimetableProjection {
        Integer getId();
