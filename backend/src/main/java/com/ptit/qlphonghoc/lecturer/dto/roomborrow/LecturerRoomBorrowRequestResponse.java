...
public class LecturerRoomBorrowRequestResponse {
    ...
    private Integer sectionMaxCapacity;
    ...
    public Integer getSectionMaxCapacity() {
        return sectionMaxCapacity;
    }

    public void setSectionMaxCapacity(Integer sectionMaxCapacity) {
